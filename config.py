...
# Dataset/Path Config
target_dataset = 'aircraft'     # 'aircraft', 'bird', 'car'

# model save and logging
log_name = "train.log"
# save_dir = './FGVC/CUB-200-2011/ckpt/' ########### Linux
...
# eval_savepath = './FGVC/CUB-200-2011/visualize/'  ########### Linux
eval_savepath = "FGVC\\CUB-200-2011\\visualize\\" ########### Windows