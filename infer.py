...
def get_args(add_help=True):
    ...
    parser.add_argument(
        "--model-dir", default='output', help="inference model dir")
    parser.add_argument(
    ...
    parser.add_argument(
        "--resize-size", default=512, type=int, help="resize_size")
    parser.add_argument("--crop-size", default=448, type=int, help="crop_szie")
    parser.add_argument("--img-path", default="datasets/CUBTINY/3.jpg")
...
if __name__ == "__main__":
    ...
    print("class_id:{}, prob:{:.3f}".format(class_id, prob))
